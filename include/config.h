...
// --- Onboard BOOT button (active LOW) ---
...
#if defined(PLANE_RADAR_XIAO_C6)
constexpr gpio_num_t kDisplayPinRst = GPIO_NUM_0;
constexpr gpio_num_t kDisplayPinCs = GPIO_NUM_1;
constexpr gpio_num_t kDisplayPinDc = GPIO_NUM_2;
constexpr gpio_num_t kDisplayPinMosi = GPIO_NUM_18;
constexpr gpio_num_t kDisplayPinSclk = GPIO_NUM_19;
#else
constexpr gpio_num_t kDisplayPinRst = GPIO_NUM_0;
constexpr gpio_num_t kDisplayPinCs = GPIO_NUM_1;
